...
@section('adminContent')
    ...
    @endif
    <h3 class="text-white">Create new materi</h3>
        ...
        <div class="container">
            ...
            <form action="{{ route('materi.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="button" class="btn btn-secondary mb-3" onclick="addSubMateri()">
                    <i class="bi bi-arrow-down-square"></i> Tambah Sub Materi
                </button>
                <button type="submit" class="btn btn-primary mb-3">
                    <i class="bi bi-arrow-right-circle"></i> Simpan Materi
                </button>
            ...
            function addSubMateri() {
                ...
                subMateriItem.innerHTML = `
                            <div class="row g-3 align-items-center rounded p-3 mb-4">
                                <!-- Judul Sub Materi -->
                                <div class="col-sm-6">
                                    <label for="sub_judul[]" class="form-label">Judul Sub Materi</label>
                                    <input type="text" name="sub_judul[]" id="sub_judul[]"
                                        class="form-control form-control-sm @error('sub_judul') is-invalid @enderror"
                                        value="{{ old('sub_judul[]') }}" placeholder="Masukkan judul sub materi">
                                    @error('sub_judul')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <label for="penjelasan[]" class="form-label">Penjelasan Sub Materi</label>
                                    <textarea name="penjelasan[]" id="penjelasan[]"
                                            class="form-control form-control-sm @error('penjelasan') is-invalid @enderror"
                                            rows="3" placeholder="Masukkan penjelasan sub materi">{{ old('penjelasan[]') }}</textarea>
                                    @error('penjelasan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <!-- Kode Sub Materi -->
                                <div class="col-sm-6">
                                    <label for="kode_sub_materi[]" class="form-label">Kode Sub Materi</label>
                                    <textarea name="kode_sub_materi[]" id="kode_sub_materi[]"
                                            ...
                                            rows="3" placeholder="Masukkan kode sub materi">{{ old('kode_sub_materi[]') }}</textarea>
                                ...
                                <!-- Gambar Sub Materi -->
                                <div class="col-sm-6">
                                    <label for="foto_sub_materi[]" class="form-label">Gambar Sub Materi</label>
                                    <div class="mb-3">
                                ...
                                <div class="col-12 text-end">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="removeSubMateri(this)">
                                        <i class="bi bi-dash-circle-fill"></i> Hapus Sub Materi
                                    </button>
                                </div>
                            </div>
