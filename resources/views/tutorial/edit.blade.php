...
@section('adminContent')
    <h2 class="text-white">Edit Tutorial <span style="color: rgb(116, 116, 116); text-decoration: underline">{{ $tutorial->judul }}</span></h2>
            ...
            <form action="{{ route('tutorial.update', $tutorial->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="judul" id="judul"
                            ...
                            value="{{ old('judul', $tutorial->judul) }}" placeholder="Masukkan judul materi">
                        @error('judul')
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-sm-9">
                        <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3"
                            placeholder="Tuliskan deskripsi materi">{{ old('deskripsi', $tutorial->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="">
                            <img id="coverPreview" src="{{ $tutorial->cover ? asset('cover/' . $tutorial->cover) : '#' }}"
                                alt="Pratinjau Cover" class="img-thumbnail"
                                style="max-width: 200px; display: {{ $tutorial->cover ?: 'none' }};">
                        </div>
                        @error('cover')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <select name="kategori_id" id="kategori"
                            ...
                            @foreach ($kategoris as $kategori)
                                <option value="{{ $kategori->id }}"
                                    {{ old('kategori_id', $tutorial->kategori_id) == $kategori->id ? 'selected' : '' }}>
                                    {{ $kategori->nama }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div id="sub-materi-section" class="mb-3">
                    ...
                    @foreach ($tutorial->subTutorials as $subTutorial)
                        <div class="sub-materi-item row border rounded p-3 mb-3">
                            <input type="hidden" name="sub_materi_id[]" value="{{ $subTutorial->id }}">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" name="sub_judul[]" id="sub_judul_{{ $loop->index }}"
                                    ...
                                    value="{{ old('sub_judul.' . $loop->index, $subTutorial->sub_judul) }}"
                            ...
                            <div class="col-md-8 mb-2">
                                ...
                                <textarea name="penjelasan[]" id="penjelasan_{{ $loop->index }}"
                                    ...
                                    placeholder="Masukkan penjelasan">{{ old('penjelasan.' . $loop->index, $subTutorial->penjelasan) }}</textarea>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <textarea name="kode_sub_materi[]" id="kode_sub_materi_{{ $loop->index }}"
                                    ...
                                    placeholder="Masukkan kode">{{ old('kode_sub_materi.' . $loop->index, $subTutorial->kode) }}</textarea>
                            ...
                            <div class="col-md-8 mb-2">
                                ...
                                <textarea name="penjelasan_kode[]" id="penjelasan_kode_{{ $loop->index }}"
                                    ...
                                    placeholder="Penjelasan kode">{{ old('penjelasan_kode.' . $loop->index, $subTutorial->penjelasan_kode) }}</textarea>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="mb-2">
                                    <img id="subGambarPreview{{ $loop->index }}"
                                        src="{{ $subTutorial->foto ? asset('sub_foto/' . $subTutorial->foto) : '' }}"
                                        alt="Pratinjau foto" class="img-thumbnail"
                                        style="max-width: 200px; display: {{ $subTutorial->foto ? 'block' : 'none' }};">
                                </div>
                            ...
                            <div class="col-12 text-end">
                                <label for="delete_sub_materi_{{ $loop->index }}" class="form-label">
                                    <input type="checkbox" name="delete_sub_materi[]"
                                        id="delete_sub_materi_{{ $loop->index }}" value="{{ $subTutorial->id }}">
                                    Hapus Sub Materi
                                </label>
                            </div>
                        </div>
